...
/*
			...
			band2.style.height = band2.clientHeight+"px";
			var band1 = document.getElementById("timeline-band-1");
			band1.style.height = band1.clientHeight+"px";
}*/
			...
			/*console.log("mousedown X : " + window.mdX + "			souris X : " + cX);
			console.log(" ");
